...
function CreditsModal(props) {
	...
	const data = [
		...
		},
		{
			year: "2022",
			members:
				"Developers:\nCesar Ayala, Songtao Bu, Alejandro Ceballos, Bryan Chan, Erik Donovan-Blood, Kennard Lim, Jorge Mata, Kalvin Mateo, Misael Ortega, Jonathan Saldivar, Dustin Shin\n\nArt Designers: Diana Recinos, Linda de la Torre, Fatima Rosales, Giselle Peredo",
		},
	];
				...
				renderItem={({ item }) => {
					return (
						<View style={[styles.shadow2, styles.box]}>
							...
							<Text style={styles.description}>{item.members}</Text>
						</View>
					);
				}}
			/>
